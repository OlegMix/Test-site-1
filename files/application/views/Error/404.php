...
<link href="<?php echo URL::base(); ?>public/css/style_error.css" rel="stylesheet" type="text/css" />
...
<div class="body">
	...
	<div class="content">
		<div class="error"><img src="<?php echo URL::base(); ?>public/image/system/Error.png"><h2>404</h2></div>
		<h5>Извините, данная страница удалена или еще не создана.</h5>
		<a href='<?php echo URL::base(); ?>' style='text-decoration: none;'>На главную</a>
	</div>
	<div class="basement">
		<div class="copyright">
