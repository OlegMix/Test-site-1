...
<?php foreach($news as $news_arr): ?>
	<div class="news">
		<a href="<?php echo URL::base().'news/'.$news_arr['id_news'].'.html'; ?>"><img src="<?php echo URL::base(); ?>public/content/news/<?php echo $news_arr['image']; ?>.png" class="img_news"></a>
		<div class="text">
			<div>
			...
			<div>
				<div class="preview">
					<?php echo strip_tags(Text::limit_chars($news_arr['text'], 280, NULL, TRUE)); ?>
				</div>
				<div class="subtitle">
