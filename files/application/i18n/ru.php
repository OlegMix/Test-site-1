...
return array(
 ...
 ':field must be an color'                              => ':field должно быть кодом цвета',
 ':field must be an credit card number'                 => ':field должно быть номером кредитной карты',
 ':field must be an date'                               => ':field должно быть датой',
 ':field must be an decimal with :param2 places'  		=> ':field должно быть десятичным числом с :param2 количеством цифр',
 ':field must be an digit'                              => ':field должно быть целым числом',
 ...
 ':field must be an phone number'                       => ':field должно быть номером телефона',
 ...
 ':field must be an url'                                => ':field должно быть URL-адресом',
 
 'name'                                                 => 'Поле "Имя"',
 'family'                                               => 'Поле "Фамилия"',
 'lastname'                                             => 'Поле "Отчество"',
 'mail'                                              	=> 'Поле "E-Mail"',
 'fullname'                                             => 'Поле "ФИО"',
 'locations'                                            => 'Поле "Село/Город"',
 'age'                                              	=> 'Поле "Возраст"',
