...
<p class="pagination" align="center">
	...
	<?php if ($previous_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><?php echo __('Предыдущая') ?></a>
	<?php else: ?>
	...
	<?php if ($next_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next"><?php echo __('Следующая') ?></a>
	<?php else: ?>
